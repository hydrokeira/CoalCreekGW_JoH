...
yd = np.array([651.2]) #groundwater concentration from Meadow Spring
...
fig1.savefig('PhysicalParamsFigure_072021_maxMeasRn.png',dpi=200,bbox_inches='tight')
...
#         with open(f"{name}_exported_072021_medMC.csv", "w+") as datafile:

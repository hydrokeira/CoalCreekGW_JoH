...
# -*- coding: utf-8 -*-
"""
Created on Sat Jun  4 20:35:51 2022
...
MC_runs_date=MC_runs[MC_runs.date=="MC_output_all_0802.csv"]
...
##################################
    ...
    yd = np.array([0.06,0.1,0.2]) #discharge in cms
    ...
    yd = np.array([3., 3.2, 2.9, 4, 1.8, 10., 6]) #concentration in pC/L
    ...
    #yd = np.array([130.5]) #groundwater concentration from Meadow Spring
    ...
    Evap = 4.2e-3/60./60./24. #Evaporation Rate
    ...
    with open('CoalCreekResults_v1.pkl', 'rb') as f:
        ...
        def export_to_csv(keys, data, name):
            with open(f"{name}_exported_080221_best10AIC.csv", "w+") as datafile:
...
# fig1.savefig('PhysicalParamsFigure_080221_medMC.png',dpi=200,bbox_inches='tight')

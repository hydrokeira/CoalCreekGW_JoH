...
MC_runs_date=MC_runs[MC_runs.date=="MC_output_all_0714.csv"]
...
#stream temperature
    ...
    #yd = np.array([142.]) #groundwater concentration from Meadow Spring
    ...
    def export_to_csv(keys, data, name):
        with open(f"{name}_exported_071421_medMC_best10AIC.csv", "w+") as datafile:
...
# fig1.savefig('PhysicalParamsFigure_071421_medMC.png',dpi=200,bbox_inches='tight')

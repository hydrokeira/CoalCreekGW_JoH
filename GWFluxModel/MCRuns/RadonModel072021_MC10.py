...
# -*- coding: utf-8 -*-
"""
Created on Wed Jan 19 12:15:49 2022
...
MC_runs_date=MC_runs[MC_runs.date=="MC_output_all.csv"]
...
for i in range(50,60):
    ...
    #yd = np.array([139.5]) #groundwater concentration from Meadow Spring
    ...
    Evap = 5.5e-3/60./60./24. #Evaporation Rate
    ...
    with open('CoalCreekResults_v1.pkl', 'rb') as f:
        ...
        def export_to_csv(keys, data, name):
            with open(f"{name}_exported_072021_best10AIC.csv", "w+") as datafile:
...
# fig1.savefig('PhysicalParamsFigure_072021_medMC.png',dpi=200,bbox_inches='tight')

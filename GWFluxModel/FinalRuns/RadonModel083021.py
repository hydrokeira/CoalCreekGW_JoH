...
yd = np.array([120.]) #groundwater concentration from Meadow Spring
...
#fig1.savefig('PhysicalParamsFigure_083021_top5AICmed.png',dpi=200,bbox_inches='tight')
...
with open('CoalCreekResults_v1.pkl', 'rb') as f:
    ...
    def export_to_csv(keys, data, name):
        with open(f"{name}_exported_083021_lower95_top5AICmed.csv", "w+") as datafile:

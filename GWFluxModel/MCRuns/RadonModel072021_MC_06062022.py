...
# -*- coding: utf-8 -*-
"""
Created on Thu Mar 31 07:53:15 2022
...
def do_simulation_iteration(q):
    ...
    yd = np.array([0.04,0.06,0.12]) #discharge in cms
    ...
    yd = np.array([3.7,3.8,3.6,5.3,2.1,19.9,9.3]) #concentration in pC/L
    ...
    yd = np.array([1.87, 1.81, 2.79]) #average width
    ...
    yd = np.array([0.19, 0.12, 0.25]) #average depth
    ...
    Q_trib = (np.array([2760.]),[0.023],{'Rn':[2.1],'SO4':[364.08],'d18O':[-16.54], 'Ca':[24.603], 'Na':[2.109], 'Si':[3.513]})
    ...
    aic_file_name="AIC_Run" + str(q) + ".csv"
    ...
    radon_file_name="Radon_Value_Run" + str(q) + ".csv"
    ...
    gas_file_name="Gas_Value_Run" + str(q) + ".csv"
